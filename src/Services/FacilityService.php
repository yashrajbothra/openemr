...
class FacilityService extends BaseService
{
    ...
    public function getAll($search = array(), $isAndCondition = true)
    {
        ...
        if (isset($search['uuid'])) {
            $isValidFacility = $this->facilityValidator->validateId(
                'uuid',
                self::FACILITY_TABLE,
                $search['uuid'],
                true
            );
            if ($isValidFacility != true) {
                return $isValidFacility;
            }
    ...
    {
        $processingResult = new ProcessingResult();
        $isValidFacility = $this->facilityValidator->validateId('uuid', self::FACILITY_TABLE, $uuid, true);
        if ($isValidFacility !== true) {
            return $isValidFacility;
        }
